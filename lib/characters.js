const COL_ALIAS = {
  ...
  allies: ["allies", "ally", "companions", "partners", "associates"],
  enclaves: ["enclaves", "strongholds", "bases", "territories", "outposts"],
  motifs: ["motifs", "themes", "motifs & themes"],
  tag: ["tag", "tags"],
...
function rowToCharacter(row, map) {
  ...
  const char = {
    ...
    allies: splitList(read("allies")),
    enclaves: parseLocations(read("enclaves")),
    motifs: splitList(read("motifs")),
