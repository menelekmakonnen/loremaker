      ...
      <main className="flex min-h-screen items-center justify-center bg-[#050813] p-6 text-white">
        <div className="max-w-lg rounded-3xl border border-white/15 bg-black/60 p-8 text-center">
          ...
          <p className="mt-3 text-base text-white/70">
            The requested LoreMaker profile could not be located. Return to the character archive to explore the living universe.
          </p>
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#050813] pb-16 text-white">
        <nav className="mx-auto w-full max-w-6xl px-4 pt-8">
          <ol className="flex flex-wrap items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.35em] text-white/60">
            <li>
              <Link
                href="/"
                className="inline-flex items-center gap-2 rounded-full border border-white/20 px-3 py-1 text-[10px] font-semibold text-white/80 transition hover:border-white/40 hover:text-white"
              >
                ← Back to All Characters
              </Link>
            </li>
            <li className="hidden text-white/40 sm:block">/</li>
            <li className="text-[10px] font-semibold uppercase tracking-[0.35em] text-white/45">Character Dossier</li>
          </ol>
        </nav>
        ...
        <div className="mx-auto mt-12 grid max-w-6xl gap-10 px-4">
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              <div>
                <h3 className="text-sm font-bold uppercase tracking-[0.3em] text-white/60">Allied Factions</h3>
              ...
              <div>
                <h3 className="text-sm font-bold uppercase tracking-[0.3em] text-white/60">Enclave Strongholds</h3>
                <ul className="mt-3 space-y-2 text-base text-white/80">
          ...
          {tags.length > 0 && (
            <section className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <div className="mt-6 flex flex-wrap gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-white/70">
                {tags.map((tag) => (
